...
import com.microservices.demo.twitter.exception.TwitterToKafkaException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        LOG.info("Starting mock filtering streams with keywords {}", Arrays.toString(keywords));
    ...
    private void simulateTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
        Executors.newSingleThreadExecutor().submit(() -> {
            try {
                ...
                LOG.error("Error creating Error Status", e);
            }
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaException(e.getMessage());
        }
    }
    ...
    private static String formatTweetJsonWithParams(String[] params) {
